package com.teslamatelink.data.sync

// TODO: Wire ApiResult, TeslamateRepository, SyncRepository, GeocodeWorker
...
// import com.teslamatelink.data.repository.ApiResult
// import com.teslamatelink.data.repository.TeslamateRepository
...
class DataSyncWorker @AssistedInject constructor(
    ...
    // TODO: private val syncRepository: SyncRepository,
    ...
    override suspend fun getForegroundInfo(): ForegroundInfo {
        return createForegroundInfo(applicationContext.getString(R.string.sync_notification_progress))
    }
    ...
    override suspend fun doWork(): Result {
        ...
        foregroundAvailable = trySetForeground(applicationContext.getString(R.string.sync_notification_starting))
        ...
        try {
            ...
            for ((index, car) in cars.withIndex()) {
                try {
                    ...
                    trySetForeground(applicationContext.getString(R.string.sync_notification_syncing_car, index + 1, cars.size))
    ...
    private fun scheduleGeocoding() {
        ...
        // TODO: GeocodeWorker not yet absorbed
        /*
    ...
    private fun createNotificationChannel() {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            val channel = NotificationChannel(
                ...
                description = applicationContext.getString(R.string.sync_channel_description)
            }
