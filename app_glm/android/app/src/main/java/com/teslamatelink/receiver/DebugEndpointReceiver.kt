package com.teslamatelink.receiver
 ...
 *
 * Usage:
 *   adb shell am broadcast -n com.teslamatelink/.receiver.DebugEndpointReceiver -a com.teslamatelink.SET_ENDPOINT --es url "http://host:port"
 *
...
class DebugEndpointReceiver : BroadcastReceiver() {
    ...
    companion object {
        ...
        const val ACTION = "com.teslamatelink.SET_ENDPOINT"
    }
