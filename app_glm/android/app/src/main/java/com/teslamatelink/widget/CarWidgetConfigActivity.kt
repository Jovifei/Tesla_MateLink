...
class CarWidgetConfigActivity : ComponentActivity() {
    ...
    private sealed interface ScreenState {
        ...
        data class Picker(val cars: List<Car>) : ScreenState
            ...
            MateLinkTheme {
                ...
                LaunchedEffect(Unit) {
                    try {
                        ...
                        screenState = ScreenState.Error(e.message ?: "Failed to load cars")
                    }
                }
    ...
    private fun PickerScreen(cars: List<Car>, onCarSelected: (Car) -> Unit) {
        Scaffold(
            topBar = {
     ...
     */
    private fun confirmSelection(appWidgetId: Int, car: Car) {
