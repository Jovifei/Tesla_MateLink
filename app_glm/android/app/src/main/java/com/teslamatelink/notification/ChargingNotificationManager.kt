package com.teslamatelink.notification
...
import com.teslamatelink.domain.model.CarImageResolver
...
class ChargingNotificationManager @Inject constructor(
    ...
    fun buildNotification(
        ...
        val chargerPower = (status.chargerPower ?: 0.0).toInt()
     ...
     */
    private fun loadCarImage(car: CarRaw): Bitmap? {
        return try {
