...
import com.teslamatelink.data.local.dao.AggregateDao
import com.teslamatelink.data.local.dao.ChargeDao
import com.teslamatelink.data.local.dao.ChargeSummaryDao
import com.teslamatelink.data.local.dao.DriveDao
import com.teslamatelink.data.local.dao.DriveSummaryDao
import com.teslamatelink.data.local.dao.GeocodeCacheDao
import com.teslamatelink.data.local.dao.GeocodeProgressDao
import com.teslamatelink.data.local.dao.GeocodeQueueDao
import com.teslamatelink.data.local.dao.SavedTripDao
import com.teslamatelink.data.local.dao.SentryAlertLogDao
import com.teslamatelink.data.local.dao.SyncStateDao
import com.teslamatelink.data.local.dao.TripCountryCacheDao
import com.teslamatelink.data.local.dao.TripRouteCacheDao
import com.teslamatelink.data.local.entity.ChargeDetailAggregate
import com.teslamatelink.data.local.entity.ChargeEntity
import com.teslamatelink.data.local.entity.ChargeSummary
import com.teslamatelink.data.local.entity.DriveDetailAggregate
import com.teslamatelink.data.local.entity.DriveEntity
import com.teslamatelink.data.local.entity.DriveSummary
import com.teslamatelink.data.local.entity.GeocodeCache
import com.teslamatelink.data.local.entity.GeocodeProgress
import com.teslamatelink.data.local.entity.GeocodeQueueItem
...
import com.teslamatelink.data.local.entity.SentryAlertLog
import com.teslamatelink.data.local.entity.SyncState
import com.teslamatelink.data.local.entity.TripCountryCache
import com.teslamatelink.data.local.entity.TripRouteCache
...
abstract class AppDatabase : RoomDatabase() {
    ...
    companion object {
        const val DATABASE_NAME = "tesla_matelink.db"
