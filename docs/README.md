...
| [PRD/](PRD/) | 产品需求文档（已整合历史 glm/mimo 变体，仅保留落地版） |
| [PRD/MateLink_PRD.md](PRD/MateLink_PRD.md) | 工程总纲 PRD v1.0（融合原 glm/ + mimo/ 变体 + 工程实现，2026-07-02） |
| [PRD/MateLink_UI_PRD.md](PRD/MateLink_UI_PRD.md) | UI 交互 PRD（双主题 20 页面 + 跳转逻辑，基于 Stitch 原型） |
| [PRD/MateLink_Stitch_Swiss_PRD_2026-07-05.md](PRD/MateLink_Stitch_Swiss_PRD_2026-07-05.md) | app_mimo 移动端 PRD（基于 Stitch 白色简约版反推，页面级需求，2026-07-05） |
| [PLAN/](PLAN/) | 实施计划 |
